...
def videogame(request):
	...
	return render(request,'videogame.html',{'values':modified_data,'h_title':h_var_JSON,'v_title':v_var_JSON, 'values2': data_leaderboard, 'values3': modified_players, 'values4': data_total, 'values5': time, 'values6': finish})
